/*
 ...
 Description : Wrapper methods for calling cu kernels from CPU functions.
 ============================================================================
 */
...
void cuda_spectral_adapter(int nclusters, int nrows, int ncols, float* data1d, char method, char dist, int *clusterid)
...
//	printf("\n5. Calling CUDA Spectral Clustering Adapter...\n");
	...
	cuda_spectral_adapter(nclusters >= nrows ? nrows : nclusters, nrows, ncols, data1d, method, dist, clusterid);
