...
INC := -Iinc -Iexternal -I$(MABLAB)/extern/include
LIBS := -L$(MATLAB_INSTALL_PATH)/bin/glnxa64 -L$(LAPACK_PATH) -L$(OPENBLAS_PATH)

#put non cuda -l* stuff here
NONCU_LIBS:=-lgfortran -llapack -lblas
...
all: clean mkdir_o 
	...
	$(CXX) $(CFLAGS) $(INC) -L$(ODIR)/ -c -o $(ODIR)/fibo.o $(EXTERNAL)/cluster_3_0/fibo.cpp $(LIBS) $(NONCU_LIBS)		
	...
	$(ODIR)/AggloClustCentroidSolo.o $(ODIR)/fibo.o $(ODIR)/cluster_ensemble2cam.o $(ODIR)/cluster_util_partition2cam.o \
	...
	$(ODIR)/cluster_util_ssw.o \
	-lmat -lmx $(INC) $(ALL_LIBS) $(NONCU_LIBS) $(LIBS) -L$(ODIR)/ 
...
debug: clean mkdir_o 
	...
	$(CXX) $(DFLAGS) $(CFLAGS) $(INC) -L$(ODIR)/ -c -o $(ODIR)/fibo.o $(EXTERNAL)/cluster_3_0/fibo.cpp $(LIBS) $(NONCU_LIBS)		
